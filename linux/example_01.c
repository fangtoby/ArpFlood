...
unsigned char src_ip[4] = { 192, 168, 8, 138 };    //要检测的主机IP地址
unsigned char src_mac[6] = {0x00, 0x0c, 0x29, 0x46, 0xb3, 0x50};    //要检测的主机的MAC地址
unsigned char dst_ip[4] = { 192, 168, 8, 138 };    //目标IP地址
